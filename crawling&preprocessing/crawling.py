...
def download(url, params={}, method='GET', retries=3):
    ...
    return resp
def get_comic_date(date,name):
    date_url = 'https://newtoki.help/웹툰/일반/요일/'+date+'?sst=wr_datetime'
...
if __name__ == "__main__":
    ...
    print("***뉴토끼 다운로더***\n")
    print("받고 싶은 웹툰의 요일을 입력해주세요. ex) 월, 화, 수, 열흘")
    day = str(input("요일을 입력해 주세요: "))
    title = str(input("웹툰 제목을 입력해 주세요: "))

    c_id = get_comic_date(day,title)#4133
